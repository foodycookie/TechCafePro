...
function update_availability() {
    ...
    redirect("/admin6699/admin_crud.php");
}
// ----------------------------------------------------------------------------
// (1) Sorting
$fields = [
...
$baseSQL = "FROM users WHERE name LIKE ?";
$params = ["%$name%"];
...
<table class="table">
    ...
    <tr>
        ...
        <td><?= $m->status ?></td>
        <td>
            <button data-post="/page/admin6699/admin_update.php?user_id=<?= $m->user_id ?>">Update</button>
...
<p>
    <button data-get="/admin_insert.php">Insert</button>
    <button data-get="/admin_home.php">Back to Home</button>
</p>
